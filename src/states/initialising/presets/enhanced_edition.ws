...
state EnhancedEdition in RER_PresetManager {
  ...
  entry function EnhancedEdition_applySettings() {
    ...
    this.wrapperMultiplyFloatValue(wrapper, 'RERencountersAmbushDay', 'Katakans', 0.1);
    this.wrapperMultiplyFloatValue(wrapper, 'RERencountersAmbushDay', 'Ekimmaras', 0.1);
    this.wrapperMultiplyFloatValue(wrapper, 'RERencountersAmbushDay', 'Bruxae', 0.05);
    ...
    this.wrapperMultiplyFloatValue(wrapper, 'RERencountersAmbushNight', 'Katakans', 0.2);
    this.wrapperMultiplyFloatValue(wrapper, 'RERencountersAmbushNight', 'Ekimmaras', 0.2);
    this.wrapperMultiplyFloatValue(wrapper, 'RERencountersAmbushNight', 'Bruxae', 0.1);
    ...
    this.wrapperMultiplyFloatValue(wrapper, 'RERencountersContractDay', 'Katakans', 0.4);
    this.wrapperMultiplyFloatValue(wrapper, 'RERencountersContractDay', 'Ekimmaras', 0.4);
    this.wrapperMultiplyFloatValue(wrapper, 'RERencountersContractDay', 'Bruxae', 0.2);
    this.wrapperMultiplyFloatValue(wrapper, 'RERencountersContractDay', 'Fleders', 0.4);
    this.wrapperMultiplyFloatValue(wrapper, 'RERencountersContractDay', 'Garkains', 0.4);
    this.wrapperMultiplyFloatValue(wrapper, 'RERencountersContractNight', 'Katakans', 0.4);
    this.wrapperMultiplyFloatValue(wrapper, 'RERencountersContractNight', 'Ekimmaras', 0.4);
    this.wrapperMultiplyFloatValue(wrapper, 'RERencountersContractNight', 'Bruxae', 0.2);
    this.wrapperMultiplyFloatValue(wrapper, 'RERencountersContractNight', 'Fleders', 0.4);
    this.wrapperMultiplyFloatValue(wrapper, 'RERencountersContractNight', 'Garkains', 0.4);

    this.wrapperMultiplyFloatValue(wrapper, 'RERencountersHuntDay', 'Katakans', 0.2);
    this.wrapperMultiplyFloatValue(wrapper, 'RERencountersHuntDay', 'Ekimmaras', 0.2);
    this.wrapperMultiplyFloatValue(wrapper, 'RERencountersHuntDay', 'Bruxae', 0.1);
    this.wrapperMultiplyFloatValue(wrapper, 'RERencountersHuntDay', 'Fleders', 0.2);
    this.wrapperMultiplyFloatValue(wrapper, 'RERencountersHuntDay', 'Garkains', 0.2);
    this.wrapperMultiplyFloatValue(wrapper, 'RERencountersHuntNight', 'Katakans', 0.3);
    this.wrapperMultiplyFloatValue(wrapper, 'RERencountersHuntNight', 'Ekimmaras', 0.3);
    this.wrapperMultiplyFloatValue(wrapper, 'RERencountersHuntNight', 'Bruxae', 0.15);
    this.wrapperMultiplyFloatValue(wrapper, 'RERencountersHuntNight', 'Fleders', 0.3);
    this.wrapperMultiplyFloatValue(wrapper, 'RERencountersHuntNight', 'Garkains', 0.3);

    this.wrapperMultiplyFloatValue(wrapper, 'RERencountersHuntingGroundDay', 'Katakans', 0.1);
    this.wrapperMultiplyFloatValue(wrapper, 'RERencountersHuntingGroundDay', 'Ekimmaras', 0.1);
    this.wrapperMultiplyFloatValue(wrapper, 'RERencountersHuntingGroundDay', 'Bruxae', 0.05);
